...
hmm-assembler.pl $cur_dir/seq.fasta $snap_dir/params > $cur_dir/genome.hmm
maker -fix_nucleotides -f -c 4
gff3_merge -d $cur_dir/seq.maker.output/seq_master_datastore_index.log -o $cur_dir/seq.gff
