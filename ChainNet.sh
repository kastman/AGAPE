...
do
	...
	lastz $chr_seq $seq_file --ambiguous=iupac --format=lav > $target/lav/$chr_name.$seq_name.lav
	lavToAxt $target/lav/$chr_name.$seq_name.lav -tfa $chr_seq -fa $seq_file $target/lav/$chr_name.$seq_name.axt
