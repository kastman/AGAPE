...
if [ ! -e $comb_annot/non_orf.fasta ]; then
...
if [ -e $comb_annot/seq.fasta ]; then rm $comb_annot/seq.fasta; fi
ln -s $comb_annot/non_orf.fasta $comb_annot/seq.fasta
if [ ! -e $comb_annot/genes.gff ]; then
...
if [ ! -e $comb_annot/more_annot/gff/$out_name.genes.gff ]; then
